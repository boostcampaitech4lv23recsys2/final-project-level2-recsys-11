...
def compare_metric():
    ...
    a[1].metric(label="Precision", value=f"{m1_precision}", delta=f"{(m1_precision - m2_precision):.2f}")
    a[2].metric(label="Recall", value=f"{m2_recall}", delta=f"{(m2_recall - m1_recall):.2f}")
